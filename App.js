...
const styles = StyleSheet.create({
  ...
  inputFull: { backgroundColor: '#1E1E1E', color: '#FFFFFF', padding: 12, borderRadius: 8, marginBottom: 10, borderWidth: 1, borderColor: '#333', fontSize: 16, height: 50 },
  row: { flexDirection: 'row', alignItems: 'center' },
  inputField: { backgroundColor: '#1E1E1E', color: '#FFFFFF', padding: 12, borderRadius: 8, marginBottom: 10, borderWidth: 1, borderColor: '#333', fontSize: 16, height: 50 },
  ampmButton: { backgroundColor: '#FFD700', height: 50, borderRadius: 8, marginBottom: 10, width: 55, alignItems: 'center', justifyContent: 'center' },
